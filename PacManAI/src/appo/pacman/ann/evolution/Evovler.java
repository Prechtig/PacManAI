...
import appo.pacman.ann.controller.NeuralNetworkController;
...
public class Evovler {
	...
	public static void main(String[] args) {
		...
		pacmanController = new NeuralNetworkController(network);
	...
	/**
	 * Runs every network a number of times to see how well the generation performs
	 */
