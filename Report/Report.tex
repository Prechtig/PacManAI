...
The journal will evaluate Artificial Neural Networks, referred to as ANN, Monte Carlo Tree Search, referred to as MCTS and Behaviour Tree, referred to as BT.
...
\input{ArtificialNeuralNetwork.tex}
\input{MonteCarloTreeSearch.tex}
\input{BehaviourTree.tex}
\vfill
\pagebreak
\input{Conclusion.tex}
\section{Note}
I have cooperated with Mark Thorhauge, marth@itu.dk, and Mikkel Funch, mhvf@itu.dk, but have written my own code and report. We have talked to fully understand the algorithms, exchanged ideas for experiments and what to use as input for the algorithms.
