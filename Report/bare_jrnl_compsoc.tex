...
\title{Implementing AI in ms. Pacman}
%
%
...
\author{Andreas~Precht~Poulsen% <-this % stops a space
...
{Shell \MakeLowercase{\textit{et al.}}: Implementing AI in ms. Pacman}
...
\IEEEPARstart{T}{he} purpose of the report is to discover the usability and performance of different AI algorithms in the Ms. Pac-Man framework.
% You must have at least 2 lines in the paragraph with the drop letter
% (should never be an issue)

\hfill mds
 
\hfill October 9, 2015
...
\subsubsection{Inputs to the Artificial Neural Network}
...
\subsubsection{Outputs from the Artificial Neural Network}
...
\subsection{Teaching the Artificial Neural Network}
There are multiple ways to learn an ANN how to do best. The three major ways are: Supervised learning, unsupervised learning and reinforcement learning. 
...
A completely different approach for teaching an ANN is to use an evolutionary approach. The idea comes from biology and the 
