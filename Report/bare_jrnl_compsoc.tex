...
\begin{abstract}
Is it viable to use artificial intelligence, AI, to play Ms. Pac-Man? This journal will touch upon different methods of AI to do just that.
\end{abstract}
...
\IEEEPARstart{C}{an} a computer play Ms. Pac-Man? That is the question this journal seeks to answer. Multiple artificial intelligence, AI, algorithms will be analysed. They will have their usability and performance assessed in regards to playing Ms. Pac-Man. 
